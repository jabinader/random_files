...
class SirenFeDataSource extends SirenDataSource {
    ...
    isAllRowsSelected() {
        var _a;
        return ((_a = this.paginatedData) === null || _a === void 0 ? void 0 : _a.find(row => row.isSelected === false || row.isSelected === undefined)) === undefined;
    }
    loadParams(config) {
        var _a, _b, _c, _d, _e;
        this.page = (_a = config === null || config === void 0 ? void 0 : config.page) !== null && _a !== void 0 ? _a : DefaultFilterValue.DEFAULT_PAGE;
        this.size = (_b = config === null || config === void 0 ? void 0 : config.size) !== null && _b !== void 0 ? _b : DefaultFilterValue.DEFAULT_PAGE_SIZE;
        this.sortColumn = (_c = config === null || config === void 0 ? void 0 : config.sortColumn) !== null && _c !== void 0 ? _c : DefaultFilterValue.DEFAULT_SORT_COLUMN;
        this.sortDirection = (_d = config === null || config === void 0 ? void 0 : config.sortDirection) !== null && _d !== void 0 ? _d : DefaultFilterValue.DEFAULT_SORT_DIRECTION;
        this.keyword = (_e = config === null || config === void 0 ? void 0 : config.keyword) !== null && _e !== void 0 ? _e : DefaultFilterValue.DEFAULT_KEYWORD;
    }
    /**
...
class SirenTableComponent {
    ...
    ngOnChanges(changes) {
        var _a, _b;
        if ((_a = changes === null || changes === void 0 ? void 0 : changes.displayedColumns) === null || _a === void 0 ? void 0 : _a.previousValue) {
            this.loadColumns();
        }
        if ((_b = changes === null || changes === void 0 ? void 0 : changes.dataSource) === null || _b === void 0 ? void 0 : _b.previousValue) {
    ...
    loadColumns() {
        ...
        if (this.expandedCols.length > 0 && !((_a = this.displayedColumnsWithAction) === null || _a === void 0 ? void 0 : _a.includes(SirenTableAction.EXPAND))) {
            (_b = this.displayedColumnsWithAction) === null || _b === void 0 ? void 0 : _b.push(SirenTableAction.EXPAND);
        }
        if ((this.allowSingleSelection || this.allowMultiSelection) && !((_c = this.displayedColumnsWithAction) === null || _c === void 0 ? void 0 : _c.includes(SirenTableAction.SELECT))) {
            (_d = this.displayedColumnsWithAction) === null || _d === void 0 ? void 0 : _d.unshift(SirenTableAction.SELECT);
        }
        if (this.withDelete && !((_e = this.displayedColumnsWithAction) === null || _e === void 0 ? void 0 : _e.includes(SirenTableAction.DELETE))) {
            (_f = this.displayedColumnsWithAction) === null || _f === void 0 ? void 0 : _f.push(SirenTableAction.DELETE);
        }
        if (this.allowReordering && !((_g = this.displayedColumnsWithAction) === null || _g === void 0 ? void 0 : _g.includes(SirenTableAction.REORDER))) {
            (_h = this.displayedColumnsWithAction) === null || _h === void 0 ? void 0 : _h.unshift(SirenTableAction.REORDER);
        }
    }
    ngAfterViewInit() {
        this.connectToDatasource();
    ...
    checkDataSourcePaginatorAndSort() {
        ...
        if (this.dataSource instanceof SirenFeDataSource) {
            if (this.allowPagination) {
                (_a = this.dataSource) === null || _a === void 0 ? void 0 : _a.setPaginator(this.paginator);
            }
            (_b = this.dataSource) === null || _b === void 0 ? void 0 : _b.setSort(this.sort);
        }
    }
    connectToDatasource() {
        var _a, _b;
        (_b = (_a = this.dataSource) === null || _a === void 0 ? void 0 : _a.connect()) === null || _b === void 0 ? void 0 : _b.pipe(takeUntil(this._onDestroy)).subscribe(data => {
            if (data) {
    ...
    updateParams() {
        var _a, _b, _c, _d, _e;
        if (this.allowPagination) {
            this.page = (_a = this.dataSource) === null || _a === void 0 ? void 0 : _a.getPage();
            this.paginator.pageIndex = this.page;
            this.size = (_b = this.dataSource) === null || _b === void 0 ? void 0 : _b.getSize();
            this.paginator.pageSize = this.size;
        }
        this.sortColumn = (_c = this.dataSource) === null || _c === void 0 ? void 0 : _c.getSortColumn();
        this.sort.active = this.sortColumn;
        this.sortDirection = (_d = this.dataSource) === null || _d === void 0 ? void 0 : _d.getSortDirection();
        this.sort.direction = this.sortDirection;
        this.searchString = (_e = this.dataSource) === null || _e === void 0 ? void 0 : _e.getKeyword();
    }
    ...
    set searchChanged(input) {
        this.searchString = input === null || input === void 0 ? void 0 : input.trim();
    }
    /**
     * Selects row
    ...
    selectRowTable(event, row) {
        this.clickedRow = null;
        if (event === null || event === void 0 ? void 0 : event.checked) {
            if (!this.allowMultiSelection) {
                this.dataSource.deselectAllRows(false);
            }
    ...
    updateSelectionStatus() {
        var _a, _b, _c;
        this.isAllSelected = (_a = this.dataSource) === null || _a === void 0 ? void 0 : _a.isAllRowsSelected();
        this.partialSelection = ((_b = this.dataSource) === null || _b === void 0 ? void 0 : _b.getSelectionCounter()) > 0;
        this.selectedRowCounter = (_c = this.dataSource) === null || _c === void 0 ? void 0 : _c.getSelectionCounter();
    }
    /**
    ...
    quickSearchChanged(keyword) {
        keyword = keyword === null || keyword === void 0 ? void 0 : keyword.trim().toLowerCase();
        if (keyword !== this.previousKeyword && this.allowFiltering) {
            ...
            keyword = keyword === null || keyword === void 0 ? void 0 : keyword.trim().toLowerCase(); // Remove whitespace
...
class SirenBeDataSource extends SirenDataSource {
    ...
    getSize() {
        var _a, _b;
        return (_b = (_a = this.params) === null || _a === void 0 ? void 0 : _a.size) !== null && _b !== void 0 ? _b : DefaultFilterValue.DEFAULT_PAGE_SIZE;
    }
    getPage() {
        var _a, _b;
        return (_b = (_a = this.params) === null || _a === void 0 ? void 0 : _a.page) !== null && _b !== void 0 ? _b : DefaultFilterValue.DEFAULT_PAGE;
    }
    getKeyword() {
        var _a, _b;
        return (_b = (_a = this.params) === null || _a === void 0 ? void 0 : _a.keyword) !== null && _b !== void 0 ? _b : DefaultFilterValue.DEFAULT_KEYWORD;
    }
    getSortColumn() {
        var _a, _b;
        return (_b = (_a = this.params) === null || _a === void 0 ? void 0 : _a.sortColumn) !== null && _b !== void 0 ? _b : DefaultFilterValue.DEFAULT_SORT_COLUMN;
    }
    getSortDirection() {
        var _a, _b;
        return (_b = (_a = this.params) === null || _a === void 0 ? void 0 : _a.sortDirection) !== null && _b !== void 0 ? _b : DefaultFilterValue.DEFAULT_SORT_DIRECTION;
    }
    getCount() {
        return this.count;
    }
    isAllRowsSelected() {
        var _a;
        return ((_a = this.data) === null || _a === void 0 ? void 0 : _a.find(row => row.isSelected === false || row.isSelected === undefined)) === undefined;
    }
    /**
    ...
    fetchData(params, showLoader = true) {
        this.service.fetchData(params, showLoader)
            .subscribe(data => {
            const response = this.service.handleData(data === null || data === void 0 ? void 0 : data.body);
